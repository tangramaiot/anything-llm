  ...
  return (
    <div>
      ...
      <input
        ...
        className="bg-zinc-900 text-white placeholder:text-white/20 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full max-w-xs p-2.5 border border-zinc-700"
        placeholder="20"
        required={true}
        autoComplete="off"
